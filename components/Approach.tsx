    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card
          ...
          description="Once we agree on the plan, I begin the build phase and dive into coding. From initial sketches to polished code, I keep you updated every step of the way."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="After thorough testing and your final approval, I'll deploy your website to production. Post-launch, I monitor performance, gather feedback, and make refinements to ensure everything runs smoothly and meets your goals."
        >
          <CanvasRevealEffect
            animationSpeed={3}
